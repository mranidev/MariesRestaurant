    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                ...
                // Managed MySQL (e.g. Wasmer Edge) enforces sql_require_primary_key=ON,
                // which rejects tables without a primary key. TastyIgniter's schema
                // includes such tables, so relax the check per-session when
                // DB_ALLOW_NO_PRIMARY_KEY is set (used during production migrations).
                PDO::MYSQL_ATTR_INIT_COMMAND => env('DB_ALLOW_NO_PRIMARY_KEY', false)
